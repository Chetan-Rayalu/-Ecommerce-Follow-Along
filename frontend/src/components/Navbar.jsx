    ...
    <nav className="h-16 fixed top-0 left-0 right-0 z-10 w-full bg-gray-900 text-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-full">
        ...
        <div className="flex items-center">
          ...
          >
             <span className="text-yellow-300">Thala</span> Universe
          </h1>
        </div>
        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          {!hideButtons && (
            <button onClick={() => navigate('/add-product')} className="text-2xl font-semibold hover:text-yellow-300 transition">
              Add Product
            </button>
          )}
